...
# Hàm đánh giá lời xin lỗi bằng AI
...
def get_ai_response(prompt):
    ...
    if is_probability:
        ...
        elif st.session_state.warning_count == 2: return "⚠️ nhắc lại là chị chỉ giải bài tập xác suất thôi (ー_ー)"
...
if prompt := st.chat_input("em có thắc mắc gì về xác suất cần chị giải đáp không nè(´｡• ω •｡`) ♡"):
